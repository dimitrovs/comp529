/**
 * @license AngularJS v1.4.0-local+sha.d8492f4
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message += '\nhttp://errors.angularjs.org/1.4.0-local+sha.d8492f4/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.4.0-local+sha.d8492f4',    // all of these placeholder strings will be replaced by grunt's

...
!W.querySelector("[data-ng-csp]"));if(!b)try{new Function("")}catch(a){b=!0}return $a.isActive_=b},kb=function(){if(A(kb.name_))return kb.name_;var b,a,c=Ja.length,d,e;for(a=0;a<c;++a)if(d=Ja[a],b=W.querySelector("["+d.replace(":","\\:")+"jq]")){e=b.getAttribute(d+"jq");break}return kb.name_=e},Ja=["ng-","data-ng-","ng:","x-ng-"],Vd=/[A-Z]/g,xc=!1,Pb,pa=1,Ya=3,Zd={full:"1.4.0-local+sha.d8492f4",major:1,minor:4,dot:0,codeName:"snapshot"};S.expando="ng339";var sb=S.cache={},tf=1;S._data=function(b){return this.cache[b[this.expando]]||
